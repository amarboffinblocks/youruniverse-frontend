...
import { Atom, Twitter, Disc, Github } from "lucide-react";
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <Link href="/" className="flex items-center gap-2 group">
                            <div className="relative flex h-8 w-8 items-center justify-center rounded-lg bg-linear-to-tr from-blue-600 to-purple-600 shadow-lg group-hover:scale-110 transition-transform">
